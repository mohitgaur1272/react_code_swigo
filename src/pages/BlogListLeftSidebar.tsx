        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-xl-8 col-lg-8">
              <div className="dz-card blog-half style-1 m-b50 aos-item">
              ...
              <div className="dz-card blog-half style-1 m-b50 post-video aos-item">
                <div className="dz-media">
                  <Link to="#">
              ...
              <div className="dz-card blog-half style-1 m-b50 aos-item">
                <div className="dz-media">
                  <Link to="/blog-details">
                    <img src={IMAGES.blog_large_pic2} alt="" />
                  </Link>
                </div>
                <div className="dz-info">
                  <div className="dz-meta">
